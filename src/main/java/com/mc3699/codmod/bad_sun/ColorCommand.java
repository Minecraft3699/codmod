                ...
                .then(Commands.literal("grass")
                        .then(Commands.argument("color", StringArgumentType.string())
                                .executes(context -> {
                                    ...
                                    context.getSource().sendSuccess(() -> Component.literal("Grass color set to " + color), true);
                                    return 1;
                                }))
                        .then(Commands.literal("reset")
                                .executes(context -> {
                                    ...
                                    context.getSource().sendSuccess(() -> Component.literal("Grass color reset to biome defaults"), true);
                                    return 1;
                                })))
                .then(Commands.literal("foliage")
                        .then(Commands.argument("color", StringArgumentType.string())
                                .executes(context -> {
                                    ...
                                    PacketDistributor.sendToAllPlayers(new FoliageColorPayload(color, false));
                                    context.getSource().sendSuccess(() -> Component.literal("Foliage color set to " + color), true);
                                    return 1;
                                }))
                        .then(Commands.literal("reset")
                                .executes(context -> {
                                    ...
                                    PacketDistributor.sendToAllPlayers(new FoliageColorPayload(0, true));
                                    context.getSource().sendSuccess(() -> Component.literal("Foliage color reset to biome defaults"), true);
                                    return 1;
                                }))));
    }
