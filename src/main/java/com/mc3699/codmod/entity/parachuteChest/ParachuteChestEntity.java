...
public class ParachuteChestEntity extends Entity {
    ...
    public ParachuteChestEntity(Level level, ItemStackHandler items) {
        super(EntityRegistration.PARACHUTE_CHEST.get(), level);
        this.items = items;
    }
    ...
    public void tick() {
        ...
        if(onGround())
        {
            ...
            {
                serverLevel.setBlock(chestPos, Blocks.CHEST.defaultBlockState().setValue(ChestBlock.FACING, Direction.SOUTH), 3);
