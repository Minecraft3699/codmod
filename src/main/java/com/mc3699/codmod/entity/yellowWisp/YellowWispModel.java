...
public class YellowWispModel extends HierarchicalModel<YellowWispEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition base = body.addOrReplaceChild("base", CubeListBuilder.create().texOffs(0, 8).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -4.0F, 0.0F));

		PartDefinition outer = body.addOrReplaceChild("outer", CubeListBuilder.create().texOffs(0, 0).addBox(-2.0F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(1.5F)), PartPose.offset(0.0F, -4.0F, 0.0F));
